...
public class DriverActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accept = (Button) findViewById(R.id.accept_request_button);
        accept.setOnClickListener(this);

        relativeLayout = (RelativeLayout) findViewById(R.id.relative_layout_map);
                            ...
                            public void done(ParseException e) {
                                if(e == null){
                                    Intent locationIntent = new Intent(Intent.ACTION_VIEW,
                                            Uri.parse(Uri.parse("http://maps.google.com/maps?saddr="
                                                    + intent.getDoubleExtra("driverLatitude", 0))
                                                    + "," + intent.getDoubleExtra("driverLongitude", 0)
                                                    + "&addr=" + intent.getDoubleExtra("requestLatitude", 0)
